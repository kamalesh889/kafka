...
func (m *MockService) CreateProduct(arg0 *api.ProductRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockService) CreateUser(arg0 *api.UserRequest) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) DownloadAndCompressImage(arg0, arg1 string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) DownloadAndCompressImage(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
